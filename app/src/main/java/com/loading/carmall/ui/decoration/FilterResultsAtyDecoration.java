package com.loading.carmall.ui.decoration;
...
public class FilterResultsAtyDecoration extends RecyclerView.ItemDecoration {
//    private List<? extends BaseIndexTagBean> mDatas;
    ...
    public FilterResultsAtyDecoration(Context context,@NonNull String content) {
        super();
        mContent=content.length()>22?content.substring(0,21)+"...":content;
        mPaint = new Paint();
        mBounds = new Rect();
        mTitleHeight = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 50, context.getResources().getDisplayMetrics());
        mTitleFontSize = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_SP, 17, context.getResources().getDisplayMetrics());
    ...
    public FilterResultsAtyDecoration setmTitleHeight(int mTitleHeight) {
        this.mTitleHeight = mTitleHeight;
        return this;
    }


    public FilterResultsAtyDecoration setColorTitleBg(int colorTitleBg) {
        COLOR_TITLE_BG = colorTitleBg;
        return this;
    }

    public FilterResultsAtyDecoration setColorTitleFont(int colorTitleFont) {
        COLOR_TITLE_FONT = colorTitleFont;
        return this;
    }

    public FilterResultsAtyDecoration setTitleFontSize(int mTitleFontSize) {
        mPaint.setTextSize(mTitleFontSize);
        return this;
    }
...
/*
        ...
        c.drawText(mContent, child.getPaddingLeft(), child.getTop() - params.topMargin - (mTitleHeight / 2 - mBounds.height() / 2), mPaint);
    }
...
//        }
        ...
        c.drawText(tag,
                child.getPaddingLeft()+ConvertUtils.dp2px(14) ,

package com.loading.carmall.ui.weiget.indexbar.widget;
...
import com.loading.carmall.ui.weiget.indexbar.helper.IIndexBarDataHelper;
import com.loading.carmall.ui.weiget.indexbar.helper.IndexBarDataHelperImpl;
...
public class HomeIndexBar extends View {
    ...
    public HomeIndexBar(Context context) {
        this(context, null);
    }

    public HomeIndexBar(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HomeIndexBar(Context context, AttributeSet attrs, int defStyleAttr) {
     ...
     * @return
     */
    public HomeIndexBar setHeaderViewCount(int headerViewCount) {
     ...
     * @return
     */
    public HomeIndexBar setSourceDatasAlreadySorted(boolean sourceDatasAlreadySorted) {
     ...
     * @return
     */
    public HomeIndexBar setDataHelper(IIndexBarDataHelper dataHelper) {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mPaint.setColor(Color.parseColor("#666666"));//设置字体颜色
    ...
    public HomeIndexBar setmPressedShowTextView(TextView mPressedShowTextView) {
        this.mPressedShowTextView = mPressedShowTextView;
        return this;
    }

    public HomeIndexBar setmLayoutManager(LinearLayoutManager mLayoutManager) {
     ...
     * @return
     */
    public HomeIndexBar setNeedRealIndex(boolean needRealIndex) {
    ...
    public HomeIndexBar setmSourceDatas(List<? extends BaseIndexPinyinBean> mSourceDatas) {

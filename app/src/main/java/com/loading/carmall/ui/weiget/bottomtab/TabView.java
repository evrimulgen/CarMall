 ...
 * Project : 首页底部导航栏
 * Program Name :  com.loading.carmall.ui.weiget.bottomtab.TabView.java
 * Author :马庆龙 on 2017/4/20 13:29
...
public class TabView extends RelativeLayout {
    ...
    /**
     * 图标imageview宽度，默认30dp
     */
    private int mImageViewWidth;
    /**
     * 图标imageview高度，默认30dp
     */
    ...
    public void swichPostion(int position) {
        reSetAll();
        TabViewChild t = mTabViewChildList.get(position);
        LinearLayout tabChild = (LinearLayout) tabview.getChildAt(position);
        ImageView imageview = (ImageView) tabChild.getChildAt(0);

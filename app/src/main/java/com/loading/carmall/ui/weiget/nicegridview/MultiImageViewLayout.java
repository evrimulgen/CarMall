package com.loading.carmall.ui.weiget.nicegridview;
...
//        ImageLoader.getInstance().displayImage(url, mImageView);
    ...
    private void setImageGlide(Context mContext, String PicURL, ImageView mImageView) {
        ...
        glideRequest.load(PicURL).diskCacheStrategy(DiskCacheStrategy.ALL).dontAnimate().error(R.mipmap.ic_launcher).into(mImageView);
    }
}
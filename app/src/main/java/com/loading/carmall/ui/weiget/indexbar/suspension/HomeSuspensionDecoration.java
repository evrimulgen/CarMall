 ...
 * 待完成：
 */
public class HomeSuspensionDecoration extends RecyclerView.ItemDecoration {
    ...
    public HomeSuspensionDecoration(Context context, List<? extends ISuspensionInterface> datas) {
        super();
        mContext = context;
        mDatas = datas;
        mPaint = new Paint();
    ...
    public HomeSuspensionDecoration setmTitleHeight(int mTitleHeight) {
        this.mTitleHeight = mTitleHeight;
        return this;
    }


    public HomeSuspensionDecoration setColorTitleBg(int colorTitleBg) {
        COLOR_TITLE_BG = colorTitleBg;
        return this;
    }

    public HomeSuspensionDecoration setColorTitleFont(int colorTitleFont) {
        COLOR_TITLE_FONT = colorTitleFont;
        return this;
    }

    public HomeSuspensionDecoration setTitleFontSize(int mTitleFontSize) {
        mPaint.setTextSize(mTitleFontSize);
        return this;
    }

    public HomeSuspensionDecoration setmDatas(List<? extends ISuspensionInterface> mDatas) {
        this.mDatas = mDatas;
        return this;
    }
    ...
    public HomeSuspensionDecoration setHeaderViewCount(int headerViewCount) {
...
//        int marginLeft = ConvertUtils.dp2px(mContext, 16);

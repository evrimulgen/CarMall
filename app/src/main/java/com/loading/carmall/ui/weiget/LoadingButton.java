...
/**
    ...
    *Project : 首页底部导航栏
    *Program Name :  com.loading.carmall.ui.weiget.LoadingButton.java
    *Author :马庆龙 on 2017/4/27 15:36
...
public class LoadingButton extends View {
    ...
    private void init(Context context,AttributeSet attrs){
        ...
        if(attrs != null){
            ...
            mxbRadius = ta.getInt(R.styleable.LoadingButton_lb_btnRadius, 0);
        ...
        mButtonCorner = mxbRadius * mDensity;
        mPadding = 6 * mDensity;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        switch (mCurrentState) {
            ...
            case STATE_ANIMATION_STEP1:
                ...
                if(mCurrentState == STATE_BUTTON){
                    canvas.drawText(mText,(width-mTextWidth)/2,(height-mTextHeight+36)/2+mPadding*2,mTextPaint);
    ...
    private void playStartAnimation(final boolean isReverse){
        ...
        mLoadingAnimatorSet.addListener(new AnimatorEndListener() {
            @Override
    ...
    public interface OnSuccessEndListener{
       void onSuccessEnd();
    }
    private OnSuccessEndListener mOnSuccessEndListener;

    public void setOnSuccessEndListener(OnSuccessEndListener listener) {
        mOnSuccessEndListener=listener;
    }
    ...
    private void playSuccessAnimation(){
        ...
        animator.addListener(new AnimatorEndListener() {
            ...
            public void onAnimationEnd(Animator animator) {
                ...
                if (null != mOnSuccessEndListener) {
                    mOnSuccessEndListener.onSuccessEnd();
                }
            }
        });

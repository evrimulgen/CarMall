...
package com.loading.carmall.ui.weiget.multislider;
...
public class MultiSlider extends View {
    ...
    public MultiSlider(Context context, AttributeSet attrs, int defStyle, int styleRes) {
        ...
        a = context.obtainStyledAttributes(attrs,  R.styleable.MultiSlider,
                defStyle, styleRes);
        mNoInvalidate = true;
        int numThumbs = a.getInt( R.styleable.MultiSlider_thumbNumber, 2);
        initMultiSlider(numThumbs);

        Drawable trackDrawable = a.getDrawable( R.styleable
        ...
        setTrackDrawable(getTintedDrawable(trackDrawable, a.getColor( R
...
//        mMaxHeight = a.getDimensionPixelSize(R.styleable.MultiSlider_maxHeight, mMaxHeight);
        ...
        setStepsThumbsApart(a.getInt( R.styleable
                        .MultiSlider_stepsThumbsApart,
                mStepsThumbsApart));
        setDrawThumbsApart(a.getBoolean( R.styleable
                        .MultiSlider_drawThumbsApart,
                mDrawThumbsApart));
        setMax(a.getInt( R.styleable.MultiSlider_scaleMax, mScaleMax),
                true);
        setMin(a.getInt( R.styleable.MultiSlider_scaleMin, mScaleMin),
                true);


        mMirrorForRtl = a.getBoolean( R.styleable.MultiSlider_mirrorForRTL,
                mMirrorForRtl);

        // --> now place thumbs

        defThumbDrawable = a.getDrawable( R.styleable
        ...
        defRangeDrawable = a.getDrawable( R.styleable
                .MultiSlider_range);
        ...
        Drawable range1Drawable = a.getDrawable( R.styleable
                .MultiSlider_range1);
        Drawable range2Drawable = a.getDrawable( R.styleable
                .MultiSlider_range2);
        ...
        int thumbOffset = a.getDimensionPixelOffset( R.styleable
    ...
    private void setThumbDrawables(Drawable thumb, Drawable range,
        ...
        for (Thumb mThumb : mThumbs) {
            ...
            if (curr == 1 && range1 != null) {
                ...
                rCol = a.getColor( R.styleable.MultiSlider_range1Color, 0);
            } else if (curr == 2 && range2 != null) {
                rangeDrawable = range2;
                rCol = a.getColor( R.styleable.MultiSlider_range2Color, 0);
            } else {
                rangeDrawable = range;
                rCol = defRangeColor;
            }

package com.loading.carmall.ui.weiget.sidebar;
...
import com.loading.carmall.ui.weiget.sidebar.util.Geometry;


/**
 * - remove intrinsic padding and figure out why the first header is missing.
 * 删除内在的支撑，并弄清楚为什么第一个标题丢失。
...
public class BubbleScroller extends View {
    ...
    private static final long ANIM_DURATION = 150L;//150L
    private static final float BUMPER_RADIUS = 2F;//200F
    ...
    private static final int TEXT_SIZE_DEFAULT = 50;//50

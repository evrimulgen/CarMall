...
public class InformationActivityFrgAdapter extends BaseQuickAdapter<Status, BaseViewHolder> {
    public InformationActivityFrgAdapter() {
        super( R.layout.item_info_activity_frg, DataServer.getSampleData(10));
    }

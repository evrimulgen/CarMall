...
public class InformationTopicFrgAdapter
        extends BaseQuickAdapter<Status, BaseViewHolder> {
    public InformationTopicFrgAdapter() {
        super( R.layout.item_info_topic_frg, DataServer.getSampleData(10));
    }

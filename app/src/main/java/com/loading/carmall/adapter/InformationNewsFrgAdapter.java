...
public class InformationNewsFrgAdapter extends BaseQuickAdapter<Status, BaseViewHolder> {
    public InformationNewsFrgAdapter() {
        super( R.layout.item_info_news_frg, DataServer.getSampleData(10));
    }
